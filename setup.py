...
setup(
    ...
    entry_points={
        ...
        "stac_generator.inputs": [
            ...
            "rabbitmq_in = stac_generator.plugins.inputs.rabbit_mq:RabbitMQInput",
        ...
        "stac_generator.outputs": [
            "standard = stac_generator.plugins.outputs.standard:StdoutOutput",
        ...
        "stac_generator.post_processors": [
            "isodate = stac_generator.plugins.postprocessors:ISODatePostProcessor",
            "facet_map = stac_generator.plugins.postprocessors:FacetMapPostProcessor",
            "stac_bbox = stac_generator.plugins.postprocessors:BBOXPostProcessor",
            "string_join = stac_generator.plugins.postprocessors:StringJoinPostProcessor",
            "date_combinator = stac_generator.plugins.postprocessors:DateCombinatorPostProcessor",
            "facet_prefix = stac_generator.plugins.postprocessors:FacetPrefixPostProcessor",
        ],
